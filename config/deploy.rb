...
role :web, "pricessless_l.com"                          # Your HTTP server, Apache/etc
role :app, "pricessless_l.com"                         # This may be the same as your `Web` server
role :db,  "pricessless_l.com"   , :primary => true # This is where Rails migrations will run
